...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberProfile.ordering'
        db.add_column('lug_people_memberprofile', 'ordering',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberProfile.ordering'
        db.delete_column('lug_people_memberprofile', 'ordering')
