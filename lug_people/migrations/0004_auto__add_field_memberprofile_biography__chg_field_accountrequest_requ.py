...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberProfile.biography'
        db.add_column('lug_people_memberprofile', 'biography',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'AccountRequest.request_date'
        db.alter_column('lug_people_accountrequest', 'request_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'MemberProfile.biography'
        db.delete_column('lug_people_memberprofile', 'biography')


        # Changing field 'AccountRequest.request_date'
        db.alter_column('lug_people_accountrequest', 'request_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'lug_people.accountrequest': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'request_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
