...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberProfile.is_protected'
        db.add_column('lug_people_memberprofile', 'is_protected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberProfile.is_protected'
        db.delete_column('lug_people_memberprofile', 'is_protected')
